    ...
    <App>
        <div class="flex-grow flex flex-col w-10/12 mx-auto p-10">
            <div class="w-11/12 mx-auto flex justify-between items-center">
                ...
                <!-- <div><button @click.prevent="submit">Guardar</button></div> -->
            </div> 
            ...
            <div class="card w-auto">
              ...
              <div class="pt-6 pb-8 px-6">
                <form @submit.prevent="submit">
                  ...
                  <button class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition" type="submit">Importar</button>
                </form>
              </div>
              <div v-if="$page.props.flash" class="my-5 bg-green-100 rounded-md p-3 flex ">
                <svg class="stroke-2 stroke-current text-green-600 h-8 w-8 mr-2 flex-shrink-0" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round" ><path d="M0 0h24v24H0z" stroke="none" /> <circle cx="12" cy="12" r="9" /> <path d="M9 12l2 2 4-4" /> </svg>
                <div class="text-green-700">
                    <div class="font-bold text-xl">Bien hecho!</div>

                    <div>{{$page.props.flash}}</div>
                </div>
              </div> 
            </div>
        </div>
