                                            ...
                                            <div class="space-y-6 pb-5">
                                                <div>
                                                    <div class="flex items-center">
                                                        ...
                                                        <Icons class="w-5 h-5 ml-2 text-green-800 cursor-pointer" name="plus-circle" title="Agregar Categoria"/>
                                                    </div>
                                                    <div class="mt-1">
                                                        <select
                                                            class="block w-full shadow-sm sm:text-sm rounded-md focus:border-indigo-500 border-gray-300 focus:ring-indigo-50"
                                                            v-model="form.category" name="competencia"
                                                            id="competencia">
                                            ...
                                            <div class="space-y-6 pb-5">
                                                <div>
                                                    <div class="flex items-center">
                                                        ...
                                                        @click="add_competencia_relacionada()" name="plus-circle" title="Agregar Competencia"/>
                                                    </div>
                                                    <div class="mt-1">
                                                        <select
                                                            class="block w-full shadow-sm sm:text-sm rounded-md focus:border-indigo-500 border-gray-300 focus:ring-indigo-50"
...
export default {
    components: {
        Icons, Dialog, DialogOverlay, DialogTitle, TransitionChild, TransitionRoot, Datepicker
    },
    props: {
        open: Boolean,
        competencias: Object,
        ...
        add_competencia_relacionada() {
            ...
            if (resultado) {
                ...
                if (existe_competencia) {
                    data.labelType = "danger"
                    data.message = 'La competencia fue incluida previamente'
                } else {
                    let comp = {
                    ...
                    data.labelType = "success"
                    data.message = 'Se ha agregado correctamente'
                }
            } else {
                data.labelType = "danger"
